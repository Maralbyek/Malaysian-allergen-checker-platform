      ...
      if (data) {
        ...
        if (userRole !== "VENDOR") {
          toast.error("Access Denied", {
            description: `This login is for vendors only. Please use the ${userRole === "ADMIN" ? "Admin" : "Consumer"} login.`,
          })
    ...
    >
      ...
      <Card className="border-0 shadow-none lg:border lg:shadow-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-serif">Vendor Login</CardTitle>
          <CardDescription>Sign in to manage your restaurant and menu</CardDescription>
        </CardHeader>
        <CardContent>
